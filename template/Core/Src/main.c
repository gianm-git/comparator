...
static void MX_TIM4_Init(void)
{
  ...
  //Modify below as using the configurator overwrites the code above

  //define total time
  //
  //use the global variable SystemCoreClock to
  //find out what the current clock frequency is.
  // see debug window
